...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-1511264841690529.9.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-1511264841690529.9.azuredatabricks.net#setting/accounts). If
